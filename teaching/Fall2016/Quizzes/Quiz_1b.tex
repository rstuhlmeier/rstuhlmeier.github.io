...
\noindent 1. Draw lines to match the following equations with solutions. \\
...
\noindent 2. Solve the following ordinary differential equation by any method available
\[ y'(x) + \frac{3y(x)}{x} = \frac{\cos(x)}{x^3} \]
\vspace{3em}

\noindent 3. Given the following differential equation 
\[ y'(x) \cos(x) = y \sin(x)  \]
\begin{enumerate}
